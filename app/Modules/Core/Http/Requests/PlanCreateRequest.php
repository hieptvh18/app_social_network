...
class PlanCreateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'features.*.description' => 'nullable|string|max:32768',
            'features.*.value' => 'required|string',
            'features.*.resettable_period' => 'sometimes|integer',
            'features.*.resettable_interval' => 'sometimes|in:hour,day,week,month',
            'features.*.sort_order' => 'nullable|integer|max:100000',
        ];
    }

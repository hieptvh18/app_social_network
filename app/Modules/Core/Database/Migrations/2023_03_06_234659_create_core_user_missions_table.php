...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('core_user_missions', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('user_id');
            $table->morphs('entity_typeable');
            $table->string('name');
            $table->string('code');
            ...
            $table->enum('status',['TODO','DOING','WAITING_FOR_APPROVE','DONE','EXPIRED'])->default('TODO');
    ...
    {
        Schema::dropIfExists('core_user_missions');
    }
};
